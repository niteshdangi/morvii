...
class MorviiCamera extends React.Component {
  getDeepARViewHandle = () => {
...
MorviiCamera.propTypes = {
  onEventSent: PropTypes.func,
};

var RNTDeepARView = requireNativeComponent("RNTDeepARView", MorviiCamera);

export default MorviiCamera;
